  ...
  <div class="w-[1000px] mx-auto my-20 border-2 border-blue-600 p-5">
    ...
    <a-form @submit.prevent="submitForm" name="validate_other">
      <div class="mt-10">
        ...
        <div class="grid grid-cols-3 gap-2">
          ...
          <a-form-item>
            ...
            <a-upload-dragger
              v-model:fileList="
                formState.enterprise_taxpayer_identification_card
              "
              action="/upload.do"
              :rules="[
                {
                  required: false,
                  message: 'Please upload taxpayer identification card!',
                },
              ]"
            >
              <p class="ant-upload-drag-icon">
              ...
              <p class="ant-upload-text">
                Click or drag taxpayer identification card
              </p>
              <p class="ant-upload-hint">
                Support for a single or bulk upload.
              </p>
        ...
        <div class="grid grid-cols-3 gap-2">
          ...
          <a-form-item class="">
            ...
            >
              ...
              <p class="ant-upload-text">Click or drag enterprise trade name</p>
              <p class="ant-upload-hint">
                Support for a single or bulk upload.
              </p>
            </a-upload-dragger>
      ...
      <div class="flex jsutify end">
        <button type="submit" class="rounded text-white bg-blue-500 px-6 py-2">
          submit
        </button>
      </div>
    </a-form>
