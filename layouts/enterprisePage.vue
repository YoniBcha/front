<template>
    <div class="mx-10">
      <!-- header -->
      <div
        class="fixed top-3 right-10 left-10 flex justify-between items-center bg-[#0a58a4] text-white h-12 mt-3 px-2 rounded-sm"
      >
      ...
      <!-- home section  -->
      <div class="fixed top-[72px] right-10 left-10 h-[590px] overflow-y-scroll custom-scrollbar">
